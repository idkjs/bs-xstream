  ...
  module Operators = {
    ...
    external flattenFromMemory: (
      Xstream_memory.stream<stream<'a, 'b>, 'c>,
      unit,
    ) => stream<'a, 'b> = "flatten"
    @bs.send
    external flattenToMemory: (
      stream<Xstream_memory.stream<'a, 'b>, 'c>,
      unit,
    ) => Xstream_memory.stream<'a, 'b> = "flatten"
    @bs.send
    external compose: (
      stream<'a, 'b>,
    ...
    external fold: (
      ...
      ('c, 'a) => 'c,
      'c,
    ) => Xstream_memory.stream<'c, 'b> = "fold"
    @bs.send
    ...
    /* imitate */
    @bs.send
    external imitate: (stream<'a, 'b>, stream<'a, 'b>) => unit = "imitate"
  ...
  module Make_stream = (Type: StreamTypes) => {
    ...
    external createWithMemory: (
      ~producer: producer=?,
      unit,
    ) => Xstream_memory.stream<ok, error> = "createWithMemory"
